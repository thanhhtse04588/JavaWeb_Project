...
@media screen and (max-width: 300px) {
    ...
    <body>
        ...
        <div id="id01" class="modal">
            ...
            <form class="modal-content animate" action="AccountLogin" method="POST">
    ...
    <div class="container" style="background-color:#f1f1f1">
      ...
      <div id="id02" class="modal">
          <form class="modal-content animate" action="AccountRegister" method="POST">
    <div class="imgcontainer">
      ...
      <input type="password" placeholder="Re-Enter Password" name="txtRePass" required/>
      <p>${ErrorMess}</p>
